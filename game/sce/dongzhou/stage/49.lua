...
gstage = {
    ...
    map = { blocked_edges = {}, size = {44, 30}, terrain = {
        "FgFfFFFFmFFFFFFFfFfFFgFfFFfFgFFmFFFFFFmFFmFm",
        "FFfFfFFmFFFFFFFFFfFgFFfFfFFgFfFFmFFFFFFmFFmF",
        "fFFgFFFFFFmFFFFFFFgFfFFfFgFFfFfFFmFFFFFFmFFm",
        "FgFffmFFFmFFFmFFgfffffggfffffggmmFmmFmmFmmFF",
        "gFfffFFFmFFFmFFFffffggfffffggffFmmFmmFmmFFmF",
        "FfFfgFFmFFFmFFFmffggfffffggffffmFmmFmmFmmFFm",
        "FFggfFmFFFmFFFmFggfffffggfffffggfffffggffFfF",
        "gFFffmFFFmFFFmFFfffffggfffffggfffffggffffFFg",
        "FfFffggfffffggfffffggfffffggfffffggfffffggFF",
        "fFfggfffffggfffffggfffffggfffffggfffffggfFfF",
        "FgFfffffggfffffggfffffggfffffggfffffggffffFg",
        "FFffffggfffffggfffffggfffffggfffffggfffffFgF",
        "fFFfggfffffggfffffggfffffggfffffggffwwwwwwww",
        "wwwwwwwwwwwwffffggfffffggfffffwwwwwwwwwwwwww",
        "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww",
        "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwffffggFf",
        "FFfggfffffggwwwwwwwwwwwwwwwwwwfggfffffggfFfF",
        "fFFfffffggfffffggfffffggfffffggfffffggfffFFg",
        "FfFfffggfffffggfffffggfffffggfffffggfffffgFF",
        "fFffggfffffggfffffggfffffggfffffggfffffggFfF",
        "FfFgfffffggfffffggfffffggfffffggfffffggfffFf",
        "FFfffffggfffffggfffffggfffffggfffffggffffFgF",
        "fFFffggfffffggfffffggfffffggfffffggfffffgFFf",
        "FfFggfffffggfffffggfffffggfFFmFFFmFFFmFFffFF",
        "fFgfffffggfffffggfffffggfffFmFFFmFFFmFFFfFfF",
        "FFFmFmmFmmFffggfffffggfffffmFFFmFFFmFFFmfgFf",
        "FFFmmFmmFmmggfffffggfffffggFFFmFFFmFFFmFgFfF",
        "FFFFFmFFmFmFFfFfFFfFfFFgFfFFFFFFFmFFFFFFfFFf",
        "FFFFFFmFFmFfFFgFfFFfFgFFfFfFFFFFFFFFmFFFFfFF",
        "mFFFFFFmFFmFgFFfFfFFgFfFFfFmFFFFFFFmFFFFgFfF",
    }, file = "map.bmp" },
